...
if len(sys.argv) > 1:
    ...
    candidates = [
        os.path.join(_HERE, 'Results_DQ_MPCC_baseline_refined.mat'),
        os.path.join(_HERE, 'Results_DQ_MPCC_baseline_custom.mat'),
        os.path.join(_HERE, 'Results_DQ_MPCC_baseline_manual.mat'),
        os.path.join(_HERE, 'Results_DQ_MPCC_baseline_1.mat'),
    ]
